...
# Vật phẩm
BOX_RED = pygame.image.load(os.path.join("Pygame", "Chicken_Invaders", "assets","box-bullet2.png"))
...
# người chơi
PLAN = pygame.image.load(os.path.join("Pygame", "Chicken_Invaders", "assets", "plan.png"))
PLAN = pygame.transform.scale(PLAN, (80, 90))
...
class Boss(Plan):   
    def __init__(self, x, y, vel_boss_x, vel_boss_y, health=100):
        super().__init__(x, y, health)
